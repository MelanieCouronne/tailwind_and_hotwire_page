class StoriesController < ApplicationController
  ...
  def display_univers
    ...
    @selected_ile_mysterieuse = @stories.select { |story| story.universe_name == "L'île mystérieuse" }
    @selected_le_palais_merveilleux = @stories.select { |story| story.universe_name == 'Le palais merveilleux' }
